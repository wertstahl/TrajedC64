		...
		; Load dem imagez 
			...
			backgrnd= LoadImage("guimg/screen_backlay.png")
		...
		.initcursorbackground
			CopyRect ((mx/divider)*40),((mx/divider)*25),24,24,0,0,FrontBuffer(),ImageBuffer(gfxGrab)
			Return
		...
		.drawcursor			;draw mousepointer
			...
			testxx=((mx1/divider)*divider)
			testyy=((my1/divider)*divider)

			If matrix(pointr)=0 Then DrawImage gfxGrab,testxx,testyy
			...
			testx=((mx/divider)*divider)
			testy=((my/divider)*divider)

			CopyRect testx,testy,24,24,0,0,FrontBuffer(),ImageBuffer(gfxGrab)
